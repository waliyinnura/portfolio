...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn('fixed bottom-10 right-5 justify-end md:hidden', className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'fixed bottom-10 z-[999] mx-auto hidden h-16 items-end justify-center gap-4 rounded-2xl bg-gray-50 px-4 pb-3 dark:bg-neutral-900 md:flex',
        className,
      )}
